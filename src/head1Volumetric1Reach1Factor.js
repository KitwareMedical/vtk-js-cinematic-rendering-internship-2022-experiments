...
const fileURL = "https://data.kitware.com/api/v1/item/59de9dc98d777f31ac641dc1/download";
...
function createViewer(rootContainer, fileContents) {
  ...
  logLine("Head CT test 3: volume-based, 100% shade");  
  logLine("\n");
  // ----------------------------------------------------------------------------
  // FPS rader
  // ----------------------------------------------------------------------------
  ...
  piecewiseFunction.addPoint(1100.58, 0.0117188);
  piecewiseFunction.addPoint(2334.07, 0.808594);
  piecewiseFunction.addPoint(3305.9, 0.0);
  piecewiseFunction.addPoint(4095, 0.0);

  lookupTable.addRGBPoint(0.0, 0.0, 0.0, 0.0);
  lookupTable.addRGBPoint(490.071, 0.901961, 0.0, 0.0);
  lookupTable.addRGBPoint(1449.45, 0.866667, 0.0745098, 0.0196078);
  lookupTable.addRGBPoint(1511.74, 0.631373, 0.552941, 0.152941);
  lookupTable.addRGBPoint(2321.61, 0.992157, 0.992157, 0.984314);
  lookupTable.addRGBPoint(4095, 1.0, 1.0, 1.0);
  ...
  const light_pos = [center[0],center[1]+150,center[2]-100];
  ...
  renderer.getActiveCamera().setPosition(center[0]+320,center[1]+200,center[2]-160);
